...
This repository stores production releases and release artifacts only.

## Release Designations

- `production release artifact`: a versioned build that passed repository validation and was published to the Tulip production repository.
...
- the shipped desktop artifact is tested on a clean target machine
...
- `26.2R1-S1` qualifies as a production release artifact
